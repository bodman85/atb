...
let oscillatorMovingAverageFast = 0;
let oscillatorMovingAverageSlow = 0;
...
window.onload = function () {
    ...
    dataManager.pollKlinesFor(instrumentSymbol, '1m', kline => {
        ...
        oscillatorMovingAverageFast = computeAverage(oscillatorMinFast, oscillatorMaxFast);
    });
    ...
    dataManager.pollKlinesFor(instrumentSymbol, '5m', kline => {
        ...
        oscillatorMinFast = kline.k['l'];
        oscillatorMaxFast = kline.k['h'];
        oscillatorMovingAverageSlow = computeAverage(oscillatorMinFast, oscillatorMaxFast);
    });
